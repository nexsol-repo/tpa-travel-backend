...
public class CoverageController {
     ...
     */
    @GetMapping
    public CoverageResponse getCoverage(@RequestParam(name = "insurerId") Long insurerId,
            @RequestParam(name = "coverageCode") String coverageCode) {

        TravelInsuranceCoverageEntity entity = repository
            .findByInsurerIdAndCoverageCodeAndDeletedAtIsNull(insurerId, coverageCode)
            .orElseThrow(() -> new IllegalArgumentException("coverage not found: " + coverageCode));
